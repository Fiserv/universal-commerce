...
To start integrating with Connected Commerce (uCom), please refer to our <a href="../product/ConnectedCommerce/docs/?path=docs/documentation/Standard_Implementation_Guide.md">Implementation Guide</a> section.
</body>
</html>
