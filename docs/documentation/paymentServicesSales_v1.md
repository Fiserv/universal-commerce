...
Universal Commerce(uCom) brings in frictionless commerce that increases brand reach, delivers relevant & timely information to users and brings in great usability experiences in a safe & secure environment.
...
##Regions we operate
Universal Commerce(uCom) services are deployed across geography covering North America, EMEA and LATAM regions.


##What are the verticals in uCom?
...
To start integrating with Universal Commerce, please refer to our <a href="/product/UniversalCommerce/docs/?path=docs/documentation/Standard_Implementation_Guide.md">Implementation Guide</a> section.
</body>
</html>
